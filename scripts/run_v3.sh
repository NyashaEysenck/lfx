...
step "TRAIN DONE" scripts/colab_steps/train_v3.py 7200 "LoRA fine-tune on 653 examples, 6 epochs"
step "TUNED DONE" scripts/colab_steps/tuned_v3.py 3600 "predictions from lora_v3"
for f in preds_v3_real preds_v3_gen; do $C download -s "$S" "/content/$f.jsonl" "./results/$f.jsonl"; done
echo "DOWNLOADS DONE"
